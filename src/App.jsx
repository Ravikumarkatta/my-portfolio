    ...
    <main className="min-h-screen bg-gray-50 p-6 text-gray-800">
      <section className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardContent className="p-4">
                ...
                <a href="https://github.com/yourusername/movie-app" className="ml-4 text-sm text-blue-600" target="_blank">
                  GitHub ↗
                </a>
              </CardContent>
            </Card>
        ...
        <section>
          ...
          <p>Email me: <a href="mailto:youremail@example.com" className="text-blue-600">kattaravi00@gmail.com</a></p>
        </section>
      </section>
    </main>
  );
